...
ldi R16, 0
out TCCR1A, R16							//TCCR1A - Control Register A 0x0 - normal port operation
...
out OCR1AL, R16
out OCR1AH, R17							//Output compare register - compares with counter value, if match generate IRQ
