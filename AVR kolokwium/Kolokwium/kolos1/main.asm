...
_ExtInt_ISR: 	 ; increment Pulse Edge
...
_Timer_ISR: //podzieli? na 2 u?ywaj?c bitshift
    push R16
    push R17
    push R18
    push R19
	...
	mov R16, PulseEdgeCtrL	//use movw
...
_main: 
	...
	ldi R16, ((1<<CTC1) | (1<<CS12)) //uruchom CTC i prescaler 1/256
	out TCCR1B, R16

	ldi R16, (1<<OCIE1A)
	out TIMSK, R16

	LOAD_CONST R16, R17, 0x7A11 //sprawdzi? czy sta?a git
...
push R31
	...
	add R30, R16			//nie wiem czy clc nie da?
